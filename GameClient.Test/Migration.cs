		...
		public void WatchProcessesList()
		{
			...
			mongoCollection.InsertMany(new List<GameMongo>
			{
				...
				new GameMongo
				{
					...
					ProcessName = "BF1942.exe",
					Playtime = ConvertToMinutes(3, 22, 45),
					Argument = "XPack2"
				},
				new GameMongo
				{
				...
				new GameMongo
				{
					...
					Playtime = ConvertToMinutes(2, 22, 54)
				},
				new GameMongo
				{
					Name = "Company of Heroes 2",
					ProcessName = "RelicCoH2.exe",
					Playtime = ConvertToMinutes(1, 15, 22)
				},
				new GameMongo
				{
					Name = "Harry Potter and the Chamber of Secrets",
					ProcessName = "Game.exe",
					Playtime = ConvertToMinutes(0, 7, 9)
				},
				new GameMongo
				{
				...
				new GameMongo
				{
					...
					ProcessName = "hp6.exe",
					Playtime = ConvertToMinutes(0, 6, 23)
				},
				new GameMongo
				{
					Name = "Frontlines: Fuel of War",
					ProcessName = "FFOW.exe",
					Playtime = ConvertToMinutes(0, 8, 50)
				},
				new GameMongo
				{
					Name = "SWAT 4",
					ProcessName = "swat4.exe",
					Playtime = ConvertToMinutes(0, 4, 43)
				},
				new GameMongo
				{
				...
				new GameMongo
				{
					...
					Playtime = ConvertToMinutes(1, 23, 43)
				},
				new GameMongo
				{
					Name = "Endless Space",
					ProcessName = "EndlessSpace.exe",
					Playtime = ConvertToMinutes(1, 1, 56)
				},
				new GameMongo
				{
					Name = "Crysis",
					ProcessName = "Crysis64.exe",
					Playtime = ConvertToMinutes(0, 23, 12),
				},
				new GameMongo
				{
					Name = "Crysis: Warhead",
					ProcessName = "Crysis.exe",
					Playtime = ConvertToMinutes(0, 5, 20),
				},
				new GameMongo
				{
					Name = "Crysis 2",
					ProcessName = "Crysis2.exe",
					Playtime = ConvertToMinutes(0, 8, 32)
				},
				new GameMongo
				{
					Name = "Crysis 3",
					ProcessName = "Crysis3.exe",
					Playtime = ConvertToMinutes(0, 3, 15)
				},
				new GameMongo
				{
					Name = "Empire: Total War",
					ProcessName = "Empire.exe",
					Playtime = ConvertToMinutes(0, 21, 56)
				},
				new GameMongo
				{
					Name = "Total War: Rome II",
					ProcessName = "Rome2.exe",
					Playtime = ConvertToMinutes(0, 12, 16)
				},
				new GameMongo
				{
				...
				new GameMongo
				{
					...
					ProcessName = "game.exe",
					Playtime = ConvertToMinutes(0, 20, 2),
				...
				new GameMongo
				{
					...
					Playtime = ConvertToMinutes(0, 17, 35),
					Argument = "Zero Hour"
				},
				new GameMongo
				{
				...
				new GameMongo
				{
					...
					Playtime = ConvertToMinutes(0, 17, 32)
				},
				new GameMongo
				{
					Name = "Supreme Ruler Ultimate",
					ProcessName = "SupremeRulerUltimate.exe",
					Playtime = ConvertToMinutes(0, 7, 41)
				},
				new GameMongo
				{
